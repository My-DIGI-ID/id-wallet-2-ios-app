...
fileprivate extension ImageNameIdentifier {
    static let onboardingPage1 = ImageNameIdentifier(rawValue: "ImageOnboardingPage1")
    static let onboardingPage2 = ImageNameIdentifier(rawValue: "ImageOnboardingPage2")
    static let onboardingPage3 = ImageNameIdentifier(rawValue: "ImageOnboardingPage3")
}
